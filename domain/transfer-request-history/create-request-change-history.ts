...
import * as createRequestChangeModule from 'domain/transfer-request-history/create-request-change-history'
import { encrypt, encryptPII } from 'lib/emissary-crypto'
import { compareObjects } from 'lib/object-comparer'
...
export const getFilteredObject = (request: any) => {
  const { createdAt, updatedAt, notifications, transfers, history, reviews, amount, currencyUnitId, expectedTransferDate, terms, ...rest } =
    request
