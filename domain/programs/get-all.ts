...
export async function getAllPrograms({ archived = false }: FindAllProgramsProps) {
...
export async function getAllExternalPrograms() {
  const programs = await prisma.program.findMany({
    where: {
      isActive: true,
      isArchived: false,
...
export async function getAllProgramsComplete(params: any) {
...
export async function getUserRolePrograms(userId: number) {
  const programs = await prisma.program.findMany({
    where: {
      isActive: true,
      userRolePrograms: {
