import { sendApprovedNotification } from 'domain/notifications/send-approved-notification'
import { PROGRAM_TYPE_INTERNAL } from 'domain/programs/constants'
import { APPROVED_STATUS, PROCESSING_STATUS, SUBMITTED_BY_APPROVER_STATUS, SUBMITTED_STATUS } from 'domain/transfer-request/constants'
