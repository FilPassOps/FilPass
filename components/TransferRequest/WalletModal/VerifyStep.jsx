...
export function VerifyStep({ onNextStepClick, onCancelClick, formData, setUserWalletId, createWallet }) {
  ...
  useEffect(() => {
    const getWalletVerification = async address => {
      ...
      <div className="flex flex-col space-y-1">
        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="grid grid-cols-4 border space-x-4 border-gray-200 rounded-md py-3 px-3">
          ...
          <div className="col-span-1 flex flex-col justify-between">
            <Button onClick={handleSendClick} loading={sendLoading} disabled={sendLoading || loading || verification}>
              Send
            </Button>
