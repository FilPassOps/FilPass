...
import { CheckboxInput, TextInput } from 'components/Shared-tmp/FormInput'
import { GoBackConfirmation } from 'components/Shared-tmp/GoBackConfirmation'
import { DRAFT_STATUS, SUBMITTED_STATUS } from 'domain/transfer-request/constants'
import { createTransferRequestSubmittedFormValidator } from 'domain/transfer-request-draft/validation'
import { UserResult } from 'domain/user/get-by-id-and-email'
...
import { RequestAmountInput } from '../Shared-tmp/RequestAmountInput'
import { RequestorReceiver } from '../Shared-tmp/RequestorReceiver'
import { SelectProgramInput } from '../Shared-tmp/SelectProgramInput'
