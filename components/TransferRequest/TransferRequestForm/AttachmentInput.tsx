...
export const AttachmentInput = ({
  ...
  return (
    <>
      ...
      {attachmentData && (
        <div className="flex items-center gap-6 text-green-700 text-sm font-bold">
          ...
          <div className="flex items-center gap-1">
            <Button
              ...
              buttonStyle="rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-700 py-1 px-1"
              defaultStyle={false}
