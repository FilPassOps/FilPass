...
import { CheckCircleThinIcon } from 'components/Shared-tmp/icons/CheckCircleThinIcon'
import { XCircleThinIcon } from 'components/Shared-tmp/icons/XCircleThinIcon'
...
export const SubmittedModal = ({ openModal, hasError }: SubmittedModalProps) => {
  return (
        ...
        {hasError ? (
          <>
            ...
            <p className="text-sm text-gray-500 mb-8 text-center">
              Something went wrong while create the transfer request.
              <br />
              Please try again
            </p>
            <div>
