...
interface SelectFormFileInputProps {
  isUSResident?: string
  setUserFileId: (id?: string) => void
  userFileId?: string
}

export const SelectFormFileInput = ({ isUSResident, setUserFileId, userFileId }: SelectFormFileInputProps) => {
...
const formatLabel = (isUSResident?: string) => {
  switch (isUSResident) {
    case 'Yes':
