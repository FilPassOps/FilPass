...
interface EditTransferRequestAsApproverProps {
  data: {
    id: string
    status: string
...
export const EditTransferRequestAsApprover = ({ data, role }: EditTransferRequestAsApproverProps) => {
  ...
  return (
    <div className="my-8 max-w-3xl mx-auto">
      ...
      <div className="my-8 space-y-6">
        ...
        <TextInput name="project" label="Project Name" disabled defaultValue={data?.team} />
        <SelectInput
          options={[
            {
              label: data?.wallet_id
                ? (() => {
                    const delegatedAddress = getDelegatedAddress(data?.wallet_address)
                    return (
                      data?.wallet_address && (
                        <>
                          <WalletAddress
                            ...
                            delegatedAddress={data.delegated_address ?? delegatedAddress?.shortAddress}
