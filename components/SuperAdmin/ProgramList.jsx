...
export const ProgramList = ({
  ...
  const handleOpenArchiveModal = program => {
...
const getGroupColumnValue = ({ groupList, groupName, membersName }) => {
...
const GroupColumnValue = ({ groupList, groupName = 'Multistage', membersName = 'approvers' }) => {
  ...
  return (
    <Popover className="relative">
      <Popover.Button className="relative after:absolute after:-inset-2" ref={reference}>
