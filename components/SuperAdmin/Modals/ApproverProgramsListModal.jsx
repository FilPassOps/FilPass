...
export const ApproverProgramsListModal = ({ data = [], open, onModalClosed }) => {
  ...
  return (
    <Modal open={open} onModalClosed={onModalClosed} className="p-0 w-2/4 rounded">
      ...
      <div className="p-4 bg-gray-50">
              ...
              return (
                <tr key={program.id}>
                  ...
                  <Cell className="break-all">
                    {formatPaymentMethod(program.request_unit, program.payment_unit)}
                  </Cell>
        ...
        {!hasProgram.length && (
          <p className="text-center text-sm space-y-7 py-7 text-gray-800 bg-white border border-gray-100 rounded-sm">
            No data
          </p>
        )}
      </div>
