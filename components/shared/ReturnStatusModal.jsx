...
export function ReturnStatusModal({ handleClose, success, title = 'Modal title', description = 'Modal description', isOpen }) {
  return (
...
function SuccessContent({ handleClose, title, description }) {
  return (
...
function ErrorContent({ handleClose, title, description }) {
  return (
    <div className="w-full h-full flex flex-col justify-center items-center">
