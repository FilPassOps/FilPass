...
export const StatusBadge = ({ status = 'paid' }: StatusBadgeProps) => {
...
export const StatusPill = ({ status = 'paid' }: StatusPillProps) => {
  const { className, style, text } = config[status.toLowerCase()]
...
const config: Record<string, { className: string; text: string; style: any }> = {
  paid: {
